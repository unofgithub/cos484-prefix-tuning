...
def main():
    ...
    if 'lowdata' in training_args.output_dir:
        ...
        os.system('python gpt2/nucleus/gen.py data2text yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/nucleus/gen.py data2text yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/nucleus/gen.py webnlg yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/nucleus/gen.py webnlg yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/nucleus/gen.py triples yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/nucleus/gen.py triples yes test {} no'.format(checkpoint_path))
