...
from train_control_ablation import PrefixTuning, PrefixEmbTuning
...
def main():
    ...
    if model_args.tuning_mode == 'prefixtune': # prefixtune
        ...
        if model_args.prefixModel_name_or_path is not None:
            ...
            if model_args.prefix_mode == 'embedding':
                ...
                model = PrefixTuning(config_prefix, model_gpt2=gpt2, use_infix = True)
                # Nobline: I added use_infix = True
            else:
                assert False, "invalid prefix mode"
    ...
    if 'lowdata' in training_args.output_dir:
        ...
        os.system('python gpt2/gen_prefix_infix_ablation.py data2text yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/gen_prefix_infix_ablation.py data2text yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/gen_prefix_infix_ablation.py webnlg yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/gen_prefix_infix_ablation.py webnlg yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/gen_prefix_infix_ablation.py triples yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/gen_prefix_infix_ablation.py triples yes test {} no'.format(checkpoint_path))
