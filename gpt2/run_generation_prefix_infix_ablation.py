...
def main():
    ...
    for prompt_idx, prompt_text in enumerate(prompt_text_lst):
        ...
        if requires_preprocessing:
            print("WRONG: ABLATION NOT RUNNING")
            ...
            print("THIS MEANS THAT THE ABLATION IS RUNNING")
            encoded_prompt = tokenizer.encode(prefix + prompt_text + prefix, add_special_tokens=False, return_tensors="pt")
