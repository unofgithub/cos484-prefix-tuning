...
def main():
    ...
    if 'lowdata' in training_args.output_dir:
        ...
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py data2text yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py data2text yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py webnlg yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py webnlg yes test {} no'.format(checkpoint_path))
        ...
        if 'earlystop' in  training_args.output_dir:
            ...
            print('python gen.py webnlg yes valid {} no'.format(checkpoint_path))
            print('python gen.py webnlg yes test {} no'.format(checkpoint_path))
            os.system('python gpt2/task_relevant_prefix_ablation/task_relevant_prefix_ablation/gen.py webnlg yes valid {} no'.format(checkpoint_path))
            os.system('python gpt2/task_relevant_prefix_ablation/task_relevant_prefix_ablation/gen.py webnlg yes test {} no'.format(checkpoint_path))
        ...
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py triples yes valid {} no'.format(checkpoint_path))
        os.system('python gpt2/task_relevant_prefix_ablation/gen.py triples yes test {} no'.format(checkpoint_path))
